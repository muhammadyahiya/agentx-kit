...
def _write_manifest(target: Path, spec: ProjectSpec) -> Path:
    ...
    manifest = {
        ...
        "features": {
            ...
            "deep_planning": spec.deep_planning if spec.agent_mode == "deep" else None,
            "deep_filesystem": spec.deep_filesystem if spec.agent_mode == "deep" else None,
            "deep_reflection": spec.deep_reflection if spec.agent_mode == "deep" else None,
            "memory": spec.memory,
            "mcp": spec.use_mcp,
